...
data_dt = data[data['Author Keywords'].str.contains('digital twin', na=False)]
...
keyword_counts = keyword_counts[keyword_counts.index != 'digital twin']
